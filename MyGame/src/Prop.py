...
#
#
# PROP_PATH = path.join(path.dirname(__file__), "..", "asset", "image")
#
#
...
#         self.image = pygame.image.load(path.join(PROP_PATH, f"mob_{self.img_index}.png"))
...
#                                       file_path=path.join(PROP_PATH, f"mob_{self.img_index}.png"),
#                                       github_raw_url="")
