...
[![SingleGame](https://img.shields.io/github/v/tag/Jesse-Jumbo/GameFramework)](https://github.com/Jesse-Jumbo/GameFramework/tree/0.4.3)
...
- 在 SingleGame 打開終端機，複製貼上即可 以預設參數啟動遊戲。
  ```bash
